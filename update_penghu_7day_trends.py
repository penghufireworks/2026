...
def generate_table_rows(data_list, is_rising=False):
    ...
    for i, item in enumerate(data_list):
        ...
        <tr style="border-bottom: 1px solid #f0f0f0;">
            <td style="padding: 20px 8px; color: #5f6368; width: 30px; font-size: 20px;">{i+1}</td>
            <td style="padding: 20px 8px; font-weight: 500; color: #202124; font-size: 20px;">{item['query']}</td>
            <td style="padding: 20px 8px; text-align: right; color: #5f6368; font-size: 20px;">
